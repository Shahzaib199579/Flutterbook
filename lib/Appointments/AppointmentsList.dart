...
import 'AppointmentsModel.dart'
    show appointmentsModel, Appointment, AppointmentsModel;
...
class AppointmentsList extends StatelessWidget {
                          ...
                          children: <Widget>[
                            ...
                            Expanded(
                              child: ListView.builder(
                                  ...
                                  itemBuilder:
                                      (BuildContext inBuildContext, int index) {
  ...
  void _editAppointment(BuildContext context, Appointment appointment) async {
    ...
    if (appointmentsModel.entityBeingEdited.apptDate == null) {
      ...
      appointmentsModel.setChosenDate(
          DateFormat.yMMMMd("en_US").format(requiredDate.toLocal()));
    }
    ...
    if (appointmentsModel.entityBeingEdited.apptTime == null) {
      ...
      TimeOfDay requiredTime = TimeOfDay(
